          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" href="/">
                <h2 className="text-black dark:text-white text-4xl font-bold">Mini Loan App</h2>
              </Link>
              <p className="2xl:px-20">Please register to take the loans you wish to take up.</p>
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  ...
                  {errors.street && <p className="mt-2 text-sm text-red-500">{errors.street}</p>}
                </div>
                <div className="mb-4">
                  <label
                    htmlFor="city"
